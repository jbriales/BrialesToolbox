classdef CFrame < handle
    ...
    methods
        function has = get.hasMetafile(this), has = exist(this.path_metafile,'file'); end
    end
    ...
    methods
        ...
        function metapath = get.metapath( this )
            [base,folder] = fileparts( this.path );
            metapath = fullfile( base, ['meta_',folder] );
        end
