classdef CExperimentState < handle
    ...
    %   experimentState = CExperimentState( numberOfExperiments )
    % and call experimentState.update method after finishing
    % each iteration to produce verbose output in the program.
